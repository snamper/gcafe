    ...
    public class gcafeSvc : IgcafeSvc
    {
            ...
            try
            {
                using (var context = new gcafeEntities())
                {
                    List<menu> menus = context.menu
                        .Include("setmeal_item.menu1")
                        .Include("setmeal_item.setmeal_item_opt")
        ...
        public List<Method> GetMethods()
        {
            ...
            try
            {
                using (var context = new gcafeEntities())
                {
                    List<method> methods = context.method.Include("method_catalog").ToList();
        ...
        public List<MethodCatalog> GetMethodCatalogs()
        {
            ...
            try
            {
                using (var context = new gcafeEntities())
                {
                    List<method_catalog> methodCatalogs = context.method_catalog.Include("method").ToList();
